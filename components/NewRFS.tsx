...
import { ChevronLeft, ChevronDown, ChevronUp, ChevronRight, Users, Calendar, X, Package, Compass, Tag, Hash, File, FileText, Image } from 'lucide-react';
...
interface NewRFSProps {
  onClose: () => void;
}

const NewRFS: React.FC<NewRFSProps> = ({ onClose }) => {
  ...
  const [attachments, setAttachments] = useState([
    { id: '1', name: 'RFS_Specification.pdf', type: 'pdf' as const, size: '1.8 MB' },
  ]);
    ...
    <>
      <div className="fixed inset-0 bg-[#faf9f6] dark:bg-slate-900 z-[60] flex flex-col animate-in slide-in-from-bottom duration-300">
        ...
        >
          ...
          <h1 className="text-lg font-extrabold text-slate-800 dark:text-slate-100 tracking-tight">Request for Submission</h1>
          ...
          <div className="px-5 pt-5" style={{ paddingBottom: 'max(2rem, calc(env(safe-area-inset-bottom) + 1rem))' }}>
            ...
            <div className="mb-6">
              ...
              <div className="bg-[#fafafa] dark:bg-slate-800 rounded-2xl p-4 border border-slate-100/50 dark:border-slate-700 relative">
                <textarea
                  ...
                  placeholder="Describe what submission is being requested..."
                  autoCapitalize="sentences"
            ...
            <div className="mb-6">
              ...
              <div className="border-2 border-dashed border-slate-200/70 dark:border-slate-700/70 rounded-2xl p-5 flex flex-col items-center justify-center gap-3 bg-gradient-to-b from-white to-[#fafafa] dark:from-slate-800 dark:to-slate-800/50 active:scale-[0.98] transition-all">
                ...
                <span className="text-[10px] font-extrabold text-slate-400 dark:text-slate-500 uppercase tracking-tight">Tap to add files</span>
              </div>
            </div>
