...
- **[IMPORTANT] Use `aecis-backend` skill when writing any custom backend code** (.NET 8, EF Core, Services, Controllers, Casbin RBAC, AutoMapper) - this ensures compliance with AECIS backend standards
